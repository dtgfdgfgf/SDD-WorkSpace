...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R6-A1 R-E11 revision 4 re-entry accounting | `finding-status-index-v1; revision=4; ledgerVersion=1.32.0; inventoryCount=131; severityCounts=Critical:8,High:32,Medium:52,Low:39; statusCounts=COMPLETED:83,OPEN:42,DECIDED:5,IN_PROGRESS:1,DISPOSITIONED:0`。Fixture repair `ea78b64` is committed and revision 4 restores only R-E11 to COMPLETED after the clean repair-and-plan tree passed 878 governance tests with 0 failures；R-D07/R-E02/R-E08/R-H03/R-H04/R-H20 remain COMPLETED，the dedicated A1 Batch note is Ready/Closed under its immediate exact-tree fail-and-demote contract，R6-A2 through R6-A6、R-E09 and R-J03 remain pending，the branch remains NOT READY TO MERGE，and `sdd-pipeline` remains experimental、default-disabled and execution-denied |
