...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R-A24 registration after the first independent CI evidence | `finding-status-index-v1; revision=12; ledgerVersion=1.40.0; inventoryCount=134; severityCounts=Critical:8,High:32,Medium:55,Low:39; statusCounts=COMPLETED:96,OPEN:2,DECIDED:0,IN_PROGRESS:1,DISPOSITIONED:35`。Revision 11 records R-A23 as COMPLETED after the fixture capture gained an explicit UTF-8 process-output decoder；revision 12 registers new Medium R-A24 as OPEN after GitHub Actions run `30199620889` proved on a clean checkout that the shared-layer suite requires gitignored consumer-space files to exist。R-E09 remains IN_PROGRESS and R-J03 remains OPEN。Current umbrella readiness is reported by the mainline-note index and the notes themselves；`sdd-pipeline` remains experimental、default-disabled and execution-denied |
