...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R-A23 fixture-decoding registration after R6-A2 through A5 accounting | `finding-status-index-v1; revision=10; ledgerVersion=1.38.0; inventoryCount=133; severityCounts=Critical:8,High:32,Medium:54,Low:39; statusCounts=COMPLETED:95,OPEN:2,DECIDED:0,IN_PROGRESS:1,DISPOSITIONED:35`。Revision 10 registers new Medium R-A23 as OPEN：the runtime-audit test fixture decodes UTF-8 child output with the parent console code page and corrupts non-ASCII JSON on CP950 hosts。R-E09 remains IN_PROGRESS and R-J03 remains OPEN。Current umbrella readiness is reported by the mainline-note index and the notes themselves；`sdd-pipeline` remains experimental、default-disabled and execution-denied |
