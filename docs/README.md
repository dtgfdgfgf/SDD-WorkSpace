...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | RB-2 completed; RB-3 through R6 remain | 共享層 125 條修復總清單（v1.10.0）；RB-2 implementation `ec25c07` 關閉 R-B21/R-B07/R-B22，恢復 R-B20/R-B05 與 R-B10/R-B24 closure；High R-B23 的本機 RunState、sidecar 與 ECI marker authenticity 邊界維持 OPEN；分支仍 NOT READY TO MERGE，`sdd-pipeline` 維持 experimental 與 denied |
