...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R6-A1 R-E11 non-self-referential revision 6 accounting | `finding-status-index-v1; revision=6; ledgerVersion=1.34.0; inventoryCount=131; severityCounts=Critical:8,High:32,Medium:52,Low:39; statusCounts=COMPLETED:83,OPEN:42,DECIDED:5,IN_PROGRESS:1,DISPOSITIONED:0`。Revision 6 restores only R-E11 to COMPLETED after committed plan `f4ca59d274fffe8f1e49950d8bf796b95eda05d6` and clean pre-accounting gates；R-D07/R-E02/R-E08/R-H03/R-H04/R-H20 remain COMPLETED。Consult the dedicated A1 note and its mainline index row for current readiness；any failed exact-tree gate requires append-only demotion。R6-A2 through R6-A6、R-E09 and R-J03 remain pending，the branch remains NOT READY TO MERGE，and `sdd-pipeline` remains experimental、default-disabled and execution-denied |
