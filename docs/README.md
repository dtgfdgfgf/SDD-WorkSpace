...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R-F04 truth restoration Ready; residual audit resumes | 共享層 128 條修復總清單（v1.25.0）；entry plan `bab1ce9` 後的 implementation `180abc0` 將 R-F04 authoritative status 校正為 DECIDED，但 retirement 尚未實作。Owner Choice A 採現行 explicit Batch/Aggregate contract；exact accounting tree 為 full suite 747/0/0/0、runtime 0/0、Batch 0/0、Aggregate 僅預期 umbrella blocker。五個 coverage obligations 留在 R-E09，R-H15 與其他 finding 不變，fold 維持 76/45/6/1。唯讀 residual audit 可恢復；分支仍 NOT READY TO MERGE，`sdd-pipeline` 維持 experimental、default-disabled 與 execution-denied |
