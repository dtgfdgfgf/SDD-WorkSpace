...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R-A23 completion after canonical CP950 repair verification | `finding-status-index-v1; revision=11; ledgerVersion=1.39.0; inventoryCount=133; severityCounts=Critical:8,High:32,Medium:54,Low:39; statusCounts=COMPLETED:96,OPEN:1,DECIDED:0,IN_PROGRESS:1,DISPOSITIONED:35`。Revision 11 records R-A23 as COMPLETED after the fixture capture gained an explicit UTF-8 process-output decoder with old-fails/new-passes discriminating evidence and owner verification in the canonical CP950 terminal。R-E09 remains IN_PROGRESS and R-J03 remains OPEN。Current umbrella readiness is reported by the mainline-note index and the notes themselves；`sdd-pipeline` remains experimental、default-disabled and execution-denied |
