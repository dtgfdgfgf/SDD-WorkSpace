...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R6-A1 R-E11 re-entry after finalization failure | `finding-status-index-v1; revision=3; ledgerVersion=1.31.0; inventoryCount=131; severityCounts=Critical:8,High:32,Medium:52,Low:39; statusCounts=COMPLETED:82,OPEN:42,DECIDED:5,IN_PROGRESS:2,DISPOSITIONED:0`。Revision 3 returns only R-E11 to IN_PROGRESS after finalization head `8f0dd46` exposed a no-op hard-coded index mutation；R-D07/R-E02/R-E08/R-H03/R-H04/R-H20 remain COMPLETED，the dedicated A1 note is Draft/Open until the fixture repair and exact-tree gates pass，R6-A2 through R6-A6 remain pending，the branch remains NOT READY TO MERGE，and `sdd-pipeline` remains experimental、default-disabled and execution-denied |
