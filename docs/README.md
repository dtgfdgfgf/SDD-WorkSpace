...
| 2026-07-12 | [`sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md`](./sdd-workspace-repair-inventory-and-update-plan-2026-07-12_zhTW.md) | R-F04 truth-restoration implementation; accounting pending | 共享層 128 條修復總清單（v1.24.0）；在 entry-plan commit `bab1ce9` 後，以日期化增補把 R-F04 authoritative status 校正為 DECIDED，精確語意是退役方向已裁定但尚未實作。R-H15 與其他 finding 不變，fold 維持 76 COMPLETED / 45 OPEN / 6 DECIDED / 1 IN_PROGRESS。Dedicated note 仍 Draft/Open/TBD，final accounting gates 與恢復 residual audit 尚待後續 commit；分支仍 NOT READY TO MERGE，`sdd-pipeline` 維持 experimental、default-disabled 與 execution-denied |
