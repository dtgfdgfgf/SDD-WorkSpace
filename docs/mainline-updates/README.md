...
|------|-------|---------------|--------|---------|
| 2026-07-15 | [`rb-1-critical-governance-gates`](./2026-07-15-rb-1-critical-governance-gates.md) | `feature/wave-3-security-and-workflows` | Draft | RB-1 implementation pending commit binding: preserve the terminal baseline task-ID inventory (RVR-01/R-B19), make readiness, conditional ECI, Analyze machine evidence, and intent obligations non-bypassable at direct Implement entry and terminal completion (RVR-02/R-D02/R-B08), and centralize trusted-schema strict-boolean workflow authorization (RVR-03/R-B20). Full suite 420/0; branch remains NOT READY TO MERGE and `sdd-pipeline` remains denied. |
...
| 2026-07-14 | [`r2-workflow-engine-integrity`](./2026-07-14-r2-workflow-engine-integrity.md) | `feature/wave-3-security-and-workflows` | Draft | Reopened by RVR-01/03 (was Ready). Commit `6a53f66`. R2 engine execution integrity: RunState relocated outside specs/ and git-ignored (R-B06/B16), DryRun ephemeral + duplicate-id + payload + replay-history dedup (R-B03/B04/B11/B12), gate fail-closed + exit-44 terminal reject + -Restart recovery (R-B01/B10), terminal implement postcondition (R-B02), fail-closed runner authorization + executed-yaml identity binding + fixture isolation + manifest entryPoints (R-B05/B13/B15/B14). Five adversarial-review defects fixed in-batch. sdd-pipeline stays denied until R6. |
