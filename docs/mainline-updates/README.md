...
|------|-------|---------------|--------|---------|
| 2026-07-20 | [`rb-5-agent-authority-process-truthfulness`](./2026-07-20-rb-5-agent-authority-process-truthfulness.md) | `feature/wave-3-security-and-workflows` | Ready | Commits `78c47eb` and `26da9a7` complete R-D01/R-D04/R-D05/R-E07/R-A22 and seal 18 of 18 historical records: 17 notes are Merged/Closed and one remains Draft/Open. The suite is 737/0/0; R-E09 remains IN_PROGRESS, `sdd-pipeline` remains denied, and the branch remains NOT READY until R6. |
...
| 2026-05-05 | [`studio-workflows-runtime`](./2026-05-05-studio-workflows-runtime.md) | `feature/wave-3-security-and-workflows` | Draft | Aggregate note remains Draft/Open/TBD after RB-5. RB-1 through RB-5 repairs and the 18-record historical migration are complete, but R-E09 remains IN_PROGRESS until R6 fresh-fixture evidence, minimum gates, promotion decision, final Aggregate accounting, and post-merge verification. `sdd-pipeline` remains experimental, default-disabled, and denied. |
