...
|------|-------|---------------|--------|---------|
| 2026-07-21 | [`r6-fresh-fixture-evidence`](./2026-07-21-r6-fresh-fixture-evidence.md) | `feature/wave-3-security-and-workflows` | Draft | R6 evidence sub-batch in progress: isolated canonical denial, DryRun, byte-mutation denial, non-ready reject/restart, ECI re-entry, Critical Analyze blocking, and partial/full terminal behavior are now reproducible. This does not promote `sdd-pipeline`, accept residuals, complete R6, or make PR #3 merge-ready. |
