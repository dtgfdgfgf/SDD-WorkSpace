...
|------|-------|---------------|--------|---------|
| 2026-07-11 | [`extension-lifecycle-hardening`](./2026-07-11-extension-lifecycle-hardening.md) | `feature/wave-3-security-and-workflows` | Draft | Path-boundary hardening for `add-extension.ps1` / `remove-extension.ps1`: id format validation + `Assert-PathInsideRoot` before any mutation, 3 negative-path regression tests, 2 new `scriptInvariants`. Closes the destructive-delete gap found by the verified 2026-07-11 external analysis. |
