...
| 2026-05-05 | [`studio-workflows-runtime`](./2026-05-05-studio-workflows-runtime.md) | `feature/wave-3-security-and-workflows` | Draft | Aggregate note remains Draft/Open/TBD. Repair `3666c4e` restores RB-5 closure and completes R-A22 with 18 of 18 sealed records valid; R-E09 remains IN_PROGRESS until R6 Aggregate, fresh-fixture, promotion, merge-accounting, and post-merge evidence. `sdd-pipeline` remains experimental, default-disabled, and denied. |
