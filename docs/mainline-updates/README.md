...
|------|-------|---------------|--------|---------|
| 2026-07-13 | [`r2-r-b06-dispatch-consistency`](./2026-07-13-r2-r-b06-dispatch-consistency.md) | `feature/wave-3-security-and-workflows` | Draft | Partial R-B06 repair for the two PR #3 review threads: deterministic ProjectRoot script dispatch and explicit setup-plan workflow feature binding; RunState relocation remains open. |
