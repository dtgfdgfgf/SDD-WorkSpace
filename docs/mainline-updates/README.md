...
|------|-------|---------------|--------|---------|
| 2026-07-21 | [`r6-conservative-non-promotion-convergence`](./2026-07-21-r6-conservative-non-promotion-convergence.md) | `feature/wave-3-security-and-workflows` | Draft | Owner Choice A entry plan registers OPEN R-B25/R-B26 and authorizes prospective direct repair of 17 findings plus 35 conditional Wave-4 dispositions. No existing status changes yet; R-E09/R-J03 remain terminal blockers, the branch remains NOT READY, and `sdd-pipeline` remains experimental, default-disabled and denied. |
