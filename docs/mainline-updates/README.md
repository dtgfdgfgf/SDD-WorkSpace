...
|------|-------|---------------|--------|---------|
| 2026-07-21 | [`r6-conservative-non-promotion-convergence`](./2026-07-21-r6-conservative-non-promotion-convergence.md) | `feature/wave-3-security-and-workflows` | Draft | Owner-authorized corrected entry plan registers OPEN R-B25/R-B26 and High OPEN R-H20, then refines R-H20 to 15 canonical generator inputs, one dependent Copilot adapter and 15 dependent Claude mirrors. No existing status changes yet; R-E09/R-J03 remain terminal blockers, the branch remains NOT READY, and `sdd-pipeline` remains experimental, default-disabled and denied. |
...
| 2026-05-05 | [`studio-workflows-runtime`](./2026-05-05-studio-workflows-runtime.md) | `feature/wave-3-security-and-workflows` | Draft | Aggregate note remains Draft/Open/TBD. Fresh-fixture evidence completed at `aef41b1`; final tested head `f2df26e` has 744/0/0/0, runtime and Batch `VALID=true`, and exactly the expected Aggregate blocker. R6 overall, R-E09, R-E11, residual dispositions, promotion, merge, and post-merge evidence remain incomplete; `sdd-pipeline` remains experimental, default-disabled, and denied. |
