...
|------|-------|---------------|--------|---------|
| 2026-07-21 | [`r6-residual-ledger-truth-restoration`](./2026-07-21-r6-residual-ledger-truth-restoration.md) | `feature/wave-3-security-and-workflows` | Draft | Entry-plan commit `bab1ce9` precedes an append-only authoritative R-F04 DECIDED clarification; retirement remains unimplemented, R-H15 and all other findings are unchanged, and the fold stays 76/45/6/1. Implementation commit identity, final gates, and accounting remain pending; R6 audit is paused and the branch remains NOT READY. |
