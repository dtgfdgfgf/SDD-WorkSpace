...
|------|-------|---------------|--------|---------|
| 2026-07-13 | [`r1-validation-and-merge-enforcement`](./2026-07-13-r1-validation-and-merge-enforcement.md) | `feature/wave-3-security-and-workflows` | Draft | Repair audit false-green paths and registry validation; replace the unused change-manifest surface with branch-level mainline-note reconciliation; standardize PowerShell 7 and repository text hygiene; harden Governance CI and establish server-side `main` merge enforcement. |
