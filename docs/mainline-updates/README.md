...
|------|-------|---------------|--------|---------|
| 2026-07-20 | [`rb-5-agent-authority-process-truthfulness`](./2026-07-20-rb-5-agent-authority-process-truthfulness.md) | `feature/wave-3-security-and-workflows` | Draft | Post-accounting revalidation at `64669c4` keeps R-D01/R-D04/R-D05/R-E07 completed but reopens R-A22: Pester remains 737/0/0, while the runtime audit has one sealed-snapshot mismatch, Batch has 22 errors, and Aggregate has 19. RB-5 repair must close before R6; the branch remains NOT READY. |
...
| 2026-05-05 | [`studio-workflows-runtime`](./2026-05-05-studio-workflows-runtime.md) | `feature/wave-3-security-and-workflows` | Draft | Aggregate note remains Draft/Open/TBD. Post-accounting evidence supersedes the earlier RB-1 through RB-5 coherence sentence: R-A22 and R-E09 are IN_PROGRESS, and the RB-5 repair must close before R6. `sdd-pipeline` remains experimental, default-disabled, and denied. |
