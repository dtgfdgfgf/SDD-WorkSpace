...
|------|-------|---------------|--------|---------|
| 2026-07-21 | [`r6-residual-ledger-truth-restoration`](./2026-07-21-r6-residual-ledger-truth-restoration.md) | `feature/wave-3-security-and-workflows` | Draft | Prospective owner-authorized plan only: R-F04 should remain DECIDED, meaning retirement is authorized but unimplemented. The later RB-4 OPEN record and final folded counts currently conflict; implementation, evidence, and accounting remain pending. R6 audit is paused and the branch remains NOT READY. |
