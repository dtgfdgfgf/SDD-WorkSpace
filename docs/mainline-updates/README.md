...
|------|-------|---------------|--------|---------|
| 2026-07-13 | [`r1-validation-and-merge-enforcement`](./2026-07-13-r1-validation-and-merge-enforcement.md) | `feature/wave-3-security-and-workflows` | Ready | Local R1 implementation `e543f6a`: repair audit false-green paths and registry validation; replace the unused change-manifest surface with branch-level mainline-note reconciliation; standardize PowerShell 7 and repository text hygiene; harden Governance CI. Hosted PR validation and the active `main` ruleset remain required before merge. |
