...
Repair `c0744641fb9c7b5edc81e2776c86e50f22fd85c4` removes the precondition, preserves the genuine
R-G01 revert-sensitive fixture body and adds the guard. The guard fails against the pre-repair
tree while naming all nine offending paths, and passes afterwards. A clean worktree holding
neither consumer directory, which reproduces the CI checkout condition, then reported 991 passed,
