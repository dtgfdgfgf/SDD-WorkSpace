...
<!-- WARNING: This file is a seeded copy from .github/agents/speckit.eci.agent.md. Direct edits will be overwritten on the next seed-claude-agents.ps1 run. To make permanent changes, edit the source file and re-seed. -->
